...
if [ -f "target/multi-db-load-tester-0.2.jar" ]; then
    echo ""
    echo "=========================================="
    echo "Build successful!"
    echo "=========================================="
    echo "JAR file: target/multi-db-load-tester-0.2.jar"
    echo "Size: $(ls -lh target/multi-db-load-tester-0.2.jar | awk '{print $5}')"
    echo ""
    ...
    echo ""
    echo "Usage example:"
    echo "  java -jar target/multi-db-load-tester-0.2.jar --help"
    echo ""
else
    echo "Build failed!"
    exit 1
